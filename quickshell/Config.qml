        ...
        JsonAdapter {
            ...
            property JsonObject settings: JsonObject {
                ...
                property JsonObject execCommands: JsonObject {
                    ...
                    property string shutdown: "systemctl poweroff"
                    property string reboot: "systemctl reboot"
                    property string suspend: "systemctl suspend"
                    property string logout: "hyprctl dispatch exit"
                }
                property JsonObject systemDetails: JsonObject {
                    property string osName: "Arch Linux"
                    property string osVersion: "Rolling Release"
                    property string ram: "32 GB"
                    property string cpu: "AMD Ryzen 5 7600"
                    property string gpu: "AMD Radeon RX 6800"
                }
